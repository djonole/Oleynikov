        ...
        if (num1 == 0 | num2 == 0) {
            ...
            try {
                ...
                if (num1 > 10 | num2 > 10 | num1 < 0 | num2 <0) {
                    System.out.println(" throws Exception //т.е. калькулятор умеет работать только с целыми цифрами от 1 до 10 одновременно.");
                    System.exit(0);
                }
                resultArab = calculate(num1, num2, oper);
                System.out.println(" " + resultArab);
            } catch (NumberFormatException e) {
                System.out.println(" throws Exception //т.к. калькулятор умеет работать только с целыми арабскими или римскими цифрами от 1 до 10 одновременно.");
            ...
            try {
                ...
                System.out.println(" throws Exception // т.к. результатом работы калькулятора с римскими числами могут быть только положительные числа.");
            }
        }
    }
